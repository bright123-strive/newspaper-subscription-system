...
<body>
    ...
    <div class="flex flex-col min-h-screen  dark:bg-gray-800">
        <header class="flex flex-col lg:flex-row items-center bg-sky-700 justify-between text-blue-600 px-8 py-4 border-b bg-sky-500 dark:border-gray-700">
            ...
            <a href="{{ route('login') }}" class="inline-flex items-center justify-center rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 h-10 px-4 py-2 text-white bg-blue-500 hover:bg-blue-600">
                Subscribe Now
            </a>
