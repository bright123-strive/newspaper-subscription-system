            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ strpos(Request::route()->uri(), 'reports')=== false ? '' : 'show' }} "
                    ...
                    <ul class="nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-white {{ Route::currentRouteName() == 'subscription-per-user' ? ' active bg-gradient-primary' : '' }} "
                                href="{{ route('subscription-per-user') }}">
                                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                    <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center"></i>
                                </div>
                                <span class="nav-link-text ms-1">Subscribers Per Client</span>
                            </a>
                        </li>
