                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a rel="tooltip" class="btn btn-success btn-link"
                                                    href="{{ route('edit-publication', $publication->id)}}" data-original-title=""
                                                    title="">
                                                ...
                                                onclick="confirm('Are you sure you want to delete this publication?') || event.stopImmediatePropagation()"
                                                wire:click="destroy({{ $publication->id }})">
